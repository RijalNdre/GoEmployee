...
<body>
    <main class="form-regis w-300 m-auto" style="font-family: poppins">
        ...
        <h1 class="h3 mb-3 fw-normal text-center fw-bold">Register dulu yuk!</h1>
        <form action="{{route('register')}}" method="POST">
            @csrf
            <div class="form-floating">
                <input type="name" name="name" class="form-control" id="floatingInput" placeholder="Username">
        ...
        <small class="d-block text-center mt-4">Sudah memiliki akun? <a href="{{route('hal_login')}}">Login</a></small>
